...
public partial class FSAccessSystem : SystemBase
{
    ...
    protected override void OnStartRunning()
    {
        ...
        string tokenRoute = string.Empty;

        switch (fsComponent.ValueRO.devEnvironment.ToString())
        {
            case "Integration":
                tokenRoute = fsComponent.ValueRO.tokenIntegration.ToString();
                break;
            case "Beta":
                tokenRoute = fsComponent.ValueRO.tokenBeta.ToString();
                break;
            case "Production":
                tokenRoute = fsComponent.ValueRO.tokenProduction.ToString();
                break;
        }
        ...
        UnityWebRequest webRequest = UnityWebRequest.Post(tokenRoute, formData);
